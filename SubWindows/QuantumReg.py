...
from numpy import random, array, zeros, ndarray, zeros_like, size, shape, mean, append,  arange, around, delete, asarray, bincount, diff, absolute, uint8
...
#import windows
from QCL.SubWindows.IRTransferSettingsWindow import IR_Transfer_Settings_Dialog
from QCL.SubWindows.SegmentationSettingsWindow import Segmentation_Settings_Dialog
from QCL.SubWindows.RegistrationSettingsWindow import Registration_Settings_Dialog
from QCL.SubWindows.maskSettingsWindow import Mask_Settings_Dialog
from QCL.SubWindows.QuantumView import QuantumView
...
from QCL.ImportShape.XML.addshape2xml import addshape2xml
from QCL.ImportShape.mis_maker_class import mismaker

from QCL.Functions.ContourFinding import FindContours, FindOpenContours
...
class QuantumReg(QtWidgets.QMainWindow):
    def __init__(self):
        super(QuantumReg, self).__init__()
    ...
    def initMe(self):
        ...
        self.setWindowTitle('QuantumRegistration')
...
#Left Layout - "infrared layout"
        # IR Buttons
        self.openQuantumView = QtWidgets.QPushButton('', self)
        self.openQuantumView.setMaximumSize(sizeMax, sizeMax)
        self.openQuantumView.setMinimumSize(sizeMin, sizeMin)
        self.openQuantumView.setIcon(QtGui.QIcon('Graphics/QuantumViewer3.png'))
        self.openQuantumView.setIconSize(QtCore.QSize(sizeIcon, sizeIcon))
        self.openQuantumView.clicked.connect(self.openQuantumView_pressed)

        #transfer IR data from QuantumViewer
        ...
        self.transferIRdata.setIcon(QtGui.QIcon('Graphics/QCLImagesButton.png'))
        ...
        self.IRTransferSettings.setIcon(QtGui.QIcon('Graphics/QCLSettingsButton.png'))
        ...
        self.segmentationButton.setIcon(QtGui.QIcon('Graphics/SegmentationButton2.png'))
        ...
        self.segmentationSettingsButton.setIcon(QtGui.QIcon('Graphics/SegmentationSettingsButton.png'))
        ...
        self.segmentationTransferButton.setIcon(QtGui.QIcon('Graphics/SegReg_button.png'))
        ...
        self.HorizontalLayout_Left.addWidget(self.openQuantumView)
        ...
        self.ColormapBox.addItem(QtGui.QIcon("Icons/gray_icon.png"), "")
        self.ColormapBox.addItem(QtGui.QIcon("Icons/binary_icon.png"), "")
        self.ColormapBox.addItem(QtGui.QIcon("Icons/gist_icon.png"), "")
        self.ColormapBox.addItem(QtGui.QIcon("Icons/inferno_icon.png"), "")
        self.ColormapBox.addItem(QtGui.QIcon("Icons/PiYg_icon.png"), "")
        ...
        self.ColormapBox2.addItem(QtGui.QIcon("Icons/gray_icon.png"), "")
        self.ColormapBox2.addItem(QtGui.QIcon("Icons/gist_icon.png"), "")
        ...
        self.nextLeft.setIcon(QtGui.QIcon('Graphics/rotateLeft.png'))
        ...
        self.QVButtonShow.setIcon(QtGui.QIcon('Graphics/QuantumViewer4.png'))
        ...
        self.maskMeanButtonShow.setIcon(QtGui.QIcon('Graphics/MaskButton.png'))
        ...
        self.segButtonShow.setIcon(QtGui.QIcon('Graphics/SegmentationButtonFull.png'))
        ...
        self.segButtonRightShow.setIcon(QtGui.QIcon('Graphics/SegmentationButtonArea.png'))
        ...
        self.segButtonSelectedShow.setIcon(QtGui.QIcon('Graphics/SegmentationButtonAreaSeg.png'))
        ...
        self.saveTIFF_Button_Segmentation.setIcon(QtGui.QIcon('Graphics/ROI_Tif_Button.png'))
...
#Right layout - "optical layout"
        ...
        self.importOptdata.setIcon(QtGui.QIcon('Graphics/SelectFolderButton2.png'))
        ...
        self.getROIButton.setIcon(QtGui.QIcon('Graphics/roi_button.png'))
        ...
        self.modifyMaskButton.setIcon(QtGui.QIcon('Graphics/RunButton.png'))
        ...
        self.maskSettingsButton.setIcon(QtGui.QIcon('Graphics/SettingsMaskButton.png'))
        ...
        self.regButton.setIcon(QtGui.QIcon('Graphics/reg_button.png'))
        ...
        self.regSettingsButton.setIcon(QtGui.QIcon('Graphics/SettingsRegistrationButton.png'))
        ...
        self.showROIButton.setIcon(QtGui.QIcon('Graphics/show_mask.png'))
        ...
        self.findContoursButton.setIcon(QtGui.QIcon('Graphics/findcontour.png'))
        ...
        self.importMisButton.setIcon(QtGui.QIcon('Graphics/ImportMisNeu.png'))
        ...
        self.writeMisButton.setIcon(QtGui.QIcon('Graphics/addregion2mis.png'))
        ...
        self.newXMLButton.setIcon(QtGui.QIcon('Graphics/SaveROI2XML.png'))
        ...
        self.addXMLButton.setIcon(QtGui.QIcon('Graphics/AddROI2XML.png'))
        ...
        self.showXMLButton.setIcon(QtGui.QIcon('Graphics/ImportXML2Shape.png'))
...
#Buttons right upper Image
        ...
        self.ColormapBoxOpt.addItem(QtGui.QIcon("Icons/gray_icon.png"), "")
        self.ColormapBoxOpt.addItem(QtGui.QIcon("Icons/binary_icon.png"), "")
        self.ColormapBoxOpt.addItem(QtGui.QIcon("Icons/gist_icon.png"), "")
        self.ColormapBoxOpt.addItem(QtGui.QIcon("Icons/inferno_icon.png"), "")
        self.ColormapBoxOpt.addItem(QtGui.QIcon("Icons/PiYg_icon.png"), "")
        ...
        self.ColormapInverted.setIcon(QtGui.QIcon('Graphics/reverseIntensityIcon.png'))
        ...
        self.IR_Button.setIcon(QtGui.QIcon('Graphics/IR_button.png'))
        ...
        self.IRmask_Button.setIcon(QtGui.QIcon('Graphics/IRmask_buttonNew.png'))
        ...
        self.Opt_Button.setIcon(QtGui.QIcon('Graphics/Opt_button.png'))
        ...
        self.Optmask_Button.setIcon(QtGui.QIcon('Graphics/Optmask_button.png'))
        ...
        self.OptIR_Button.setIcon(QtGui.QIcon('Graphics/IROpt_button.png'))
        ...
        self.OptSeg_Button.setIcon(QtGui.QIcon('Graphics/SegmentationButtonAreaSeg.png'))
        ...
        self.ROI_Button.setIcon(QtGui.QIcon('Graphics/ROI_button2.png'))
        ...
        self.TeachingPoints_Button.setIcon(QtGui.QIcon('Graphics/SetTeachingPoints.png'))
        ...
        self.openQuantumView.setToolTip('Open QuantumViewer.')
        self.transferIRdata.setToolTip('Transfer selected IR images from QuantumViewer.')
...
#left
    #opens the QuantumViewer GUI
    def openQuantumView_pressed(self):
        #open QV
        if self.QVWindow is None:
            self.QVWindow = QuantumView(parent=self)
            self.QVWindow.show()
        ...
        self.statusBar().showMessage('QV is open.')
    ...
    def transferIRdata_pressed(self):
        ...
        #set pixel Size to 4.66µm, 3.5x objective (hard coded, as we don't have metadata specified yet)
    ...
    def showIRImages(self, image_IR):
        ...
        colormap._init()
        lut = (colormap._lut * maxlut).view(ndarray)  # Convert matplotlib colormap from 0-1 to 0-255 for Qt
    ...
    def on_ColormapBox_changed(self):
        if self.QVButtonShow.isChecked() == True:
            selected_wavelength = int(abs(self.wavenumbers - int(self.currentWavenumber)).argmin())
            self.showIRImages(self.image_IR[:, :, selected_wavelength])
    ...
    def nextLeft_pressed(self):
        ...
        if selected_wavelength > 0:
            ...
            print('Selected wavenumber: ', self.wavenumbers[selected_wavelength], 'Element number: ', selected_wavelength)
            self.printWavenumber(self.wavenumbers[selected_wavelength])
        self.on_ColormapBox_changed()
    def nextRight_pressed(self):
        selected_wavelength = int(abs(self.wavenumbers - int(self.currentWavenumber)).argmin())
        if selected_wavelength < len(self.wavenumbers)-1:
            selected_wavelength = selected_wavelength + 1
            print('Selected wavenumber: ', self.wavenumbers[selected_wavelength], 'Element number: ',
                  selected_wavelength)
            self.printWavenumber(self.wavenumbers[selected_wavelength])
        self.on_ColormapBox_changed()
    ...
    def segmentationButton_pressed(self):
        ...
        if self.QVButtonShow.isChecked() == True:
            ...
            masked_image[self.mask_IR_mean == 0] = 0
        ...
        if self.QVButtonShow.isChecked() == True:
            ...
            dataHelp = image_reshaped[image_reshaped[:, 0] != 0, 0]
            data = zeros((shape(dataHelp)[0], size(index)))
            for i in range(size(index)):
                data[:, i] = image_reshaped[image_reshaped[:, 0] != 0, int(index[i])]
            if size_z == 1:
            ...
            kmeans = KMeans(init='k-means++', n_clusters=n_clus, n_init=50, max_iter=500)
            kmeans.fit(data)

            labels = kmeans.labels_ + 1

            segmented_list = zeros((size_x * size_y))
            segmented_list[image_reshaped[:, 0] != 0] = labels
    ...
    def segmentationTransferButton_pressed(self):
        ...
        transform_px_0 = float(self.PixelSizeIRValue) / 1000
        transform_px_1 = (float(self.PixelSizeOptValue_x)+float(self.PixelSizeOptValue_y))/2 / 1000
...
#right
    def importOptButton_pressed(self):
        ...
        #in this version we limited the import to .tiff files only
        if self.extension == '.tiff':
            try:
                image_optical = slide = io.imread(fname=self.fileName)
            except:
                pass
            image_optical = rotate(image_optical, -90, resize=True)
    ...
    def OpenFile(self):
        file, fileType = QtWidgets.QFileDialog.getOpenFileName(None, "Select one file", os.getcwd(), 'Files (*.tiff )')
        self.statusBar().showMessage('File has been selected.')

        return file  # return list of file names
    ...
    def regButton_pressed(self):
        ...
        moving = self.image_IR[:, :, selected_wavelength].copy()
        fixed = self.image_opt_gray.copy()

        #need to be changed to x_y
        ...
        print('px_fixed: ', pixel_size_fixed)
        print('px_moving: ', pixel_size_moving)
        print('shape_fixed: ', shape(fixed))
        print('shape_moving: ', shape(moving))
    ...
    def transformixImageMask(self, image, transformParameterMap, transform_pixelSize = 1):
        ...
        #one should be careful with this step
    ...
    def writeMIS(self):
        """" Here, we export a selected segment/contour to an existing .mis-File (adding an area or region of interest)
    ...
    def TreeItem_DeleteAll(self, item):
        try:
            key = list(self.ListRegionsInfrared.keys())
            for i in range(len(self.ListRegionsInfrared)):
